...
public class ParallelStreams {
    ...
    private static long serialMap() {
        return runAndRecordTime( () -> {
            ...
            numbers.stream().map(e -> fastMult2(e)).collect(Collectors.toList());
            numbers.stream().map(e -> slowMult2(e)).collect(Collectors.toList());
            numbers.stream().map(e -> ultraSlowMult2(e)).collect(Collectors.toList());
    ...
    private static long parallelMap() {
        ...
        return runAndRecordTime( () -> {
            ...
            //      2. effectuer un map avec slowMult2
            //      3. effectuer un map avec ultraSlowMult2
            numbers.stream().parallel().map(e -> fastMult2(e)).collect(Collectors.toList());
            numbers.stream().parallel().map(e -> slowMult2(e)).collect(Collectors.toList());
            numbers.stream().parallel().map(e -> ultraSlowMult2(e)).collect(Collectors.toList());
    ...
    private static long serialFilteredBefore() {
        ...
        return runAndRecordTime( () -> {
            numbers.stream().filter(e -> e%2==0).map(DelayedOperations::ultraSlowMult2).collect(Collectors.toList());
        });
    }
    ...
    private static long serialFilteredAfter() {
        ...
        return runAndRecordTime( () -> {
            numbers.stream().map(DelayedOperations::ultraSlowMult2).filter(e -> e%2==0).collect(Collectors.toList());
    ...
    private static long parallelFilteredBefore() {
        ...
        return runAndRecordTime( () -> {
            numbers.stream().parallel().filter(e -> e%2==0).map(DelayedOperations::ultraSlowMult2).collect(Collectors.toList());
        });
    }
    ...
    private static long parallelFilteredAfter() {
        ...
        return runAndRecordTime( () -> {
            numbers.stream().parallel().map(DelayedOperations::ultraSlowMult2).filter(e -> e%2==0).collect(Collectors.toList());
    ...
    private static long randomMap() {
        ...
        return runAndRecordTime( () -> {
            numbers.stream().parallel().map(DelayedOperations::randomlySlowMult2).collect(Collectors.toList());
        });
    }
}
