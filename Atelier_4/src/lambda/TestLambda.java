...
public class TestLambda {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("/*************************Sans streams*******************************/");
        ...
        List<String> result2 = Lambda.allMatches(list2, e -> e.toString().startsWith("h"));
        ...
        System.out.println("/*************************Avec streams*******************************/");
        ...
        //Trouve tous les entiers de la liste dont le premier chiffre est 1
        result = Lambda.filter(list, e -> e.toString().startsWith("1"));
        System.out.println(result);
        ...
        //Trouve toutes les String de la liste qui commencent par "h"
        List<String> result2Stream = Lambda.allMatches(list2, e -> e.toString().startsWith("h"));
        System.out.println(result2Stream);

        //Retournerune liste qui contient la taille de chacune des String de la liste originale
        List<Integer> result3Stream = Lambda.transformAll(list2, String::length);
        System.out.println(result3Stream);
