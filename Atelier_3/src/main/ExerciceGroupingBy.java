...
public class ExerciceGroupingBy {
    ...
    private void groupBy1() {
        ...
        Map<Trader, List<Transaction>> map = transactions
                .stream()
    ...
    private void groupBy2() {
        ...
        Map<Trader, Long> map = transactions
                .stream()
        ...
        Map<TransactionsLevel, List<Transaction>> map = transactions
                .stream().collect(
                        groupingBy(e -> {
                            ...
                            else if (e.getValue() >= 800 && e.getValue() < 1000) return TransactionsLevel.HI;
                            else if (e.getValue() >= 600 && e.getValue() < 800) return TransactionsLevel.ME;
