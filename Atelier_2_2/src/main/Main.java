...
public class Main {
	...
	public static void main(String[] args) {
		...
		livre2.ajouterPlat(plat);
		livre2.ajouterPlat(new Plat("Croquettes au fromage", 4, Difficulte.XXX, Cout.$$, Plat.Type.ENTREE));
		System.out.println(livre2);
		System.out.println("***********************************************************");
		livre2.supprimerPlat(plat);
		livre2.supprimerPlat(new Plat("Toasts aux champignons", 5, Difficulte.XXX, Cout.$$$, Plat.Type.ENTREE));
		System.out.println(livre2.tousLesPlats());
